...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "bio" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar DEFAULT 'Firstname Lastname',
  	"bio_text" varchar,
  	"pic_id" integer,
  ...
  ALTER TABLE "bio" ADD CONSTRAINT "bio_pic_id_media_id_fk" FOREIGN KEY ("pic_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "bio_pic_idx" ON "bio" USING btree ("pic_id");`)
}
